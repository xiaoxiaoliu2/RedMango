...
namespace API.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=.; Initial Catalog=RedMango; User Id=SA; password=Lzz123456*; TrustServerCertificate= True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MenuItem>().HasData(new MenuItem   // add records in the table
            {
                Id = 1,
                Name = "Spring Roll",
